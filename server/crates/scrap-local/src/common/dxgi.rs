...
impl Display {
    ...
    /// DXGI output DeviceName (e.g. `\\.\DISPLAY1`).
    /// Matches the form returned by Win32 `GetMonitorInfoW(... szDevice)` so
    /// callers can correlate a scrap Display with EnumDisplayMonitors output.
